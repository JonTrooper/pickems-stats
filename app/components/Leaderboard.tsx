...
export default function Leaderboard({ data }: { data: any[] }) {
  return (
    <div className="max-w-md m-auto">
      <Card className="mx-auto flex items-center justify-between px-2.5 py-1 dark:bg-neutral-950 hover:dark:bg-neutral-900 transition-all">
      ...
      <Card className="mx-auto flex max-w-lg items-center justify-between px-2.5 py-1 my-1.5 dark:bg-neutral-950 hover:dark:bg-neutral-900 transition-all">
        <div className="flex items-center space-x-2.5">
          <img
