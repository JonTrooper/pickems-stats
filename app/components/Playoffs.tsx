    ...
    <div className="flex w-max m-auto">
      <div className="w-32">
        ...
        <div className="border rounded-md border-zinc-800">
          ...
          <div className="bg-[#1d1d21] rounded-b-md p-1">
        ...
        <div className="rounded-md text-center bg-[#1d1d21] border border-zinc-800 p-1 my-1">
          <div className="flex gap-1.5 items-center">
        ...
        <div className="border rounded-md border-zinc-800 mt-2">
          <h2 className="rounded-t text-center bg-neutral-900 border-b border-zinc-800">
            March 29th
          </h2>
          <div className="bg-[#1d1d21] rounded-b p-1">
            <div className="flex gap-1.5 items-center">
      ...
      <div className="w-32 my-auto ml-4 grayscale opacity-25">
        ...
        <h2 className="bg-red-950 rounded p-1">March 30th</h2>
